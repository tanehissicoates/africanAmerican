...
const projects = [
  {
    title: "Barack Obama",
    cardImage: "assets/images/project-page/obama.jpg",
    description: "The First Black Predsident.",
  ...
  {
    title: "Reperations",
    cardImage: "assets/images/project-page/slavery.jpg",
    description: "Slavey has had a very strong perpetual impact on America.",
    tagimg: "https://image.flaticon.com/icons/png/512/643/643350.png",
    Previewlink: "",
    Githublink: "",
  },
  {
    title: "White Supremecy",
    cardImage: "assets/images/project-page/whiteSupremecy.jpg",
    description: "White Supremecy is deep rooted in society to this day.",
    tagimg: "https://cdn.iconscout.com/icon/free/png-512/react-1-282599.png",
    Previewlink: "",
    Githublink: "",
  },
  {
    ...
    cardImage: "assets/images/project-page/americanDream.png",
    description: "The American Dream fantasizes a true land of equality of oppurtunity, one that is often unattainable for black people.",
  ...
  {
    title: "The Nation",
    cardImage: "assets/images/project-page/capitolBuilding.png",
    description: "Our nation was built off the back of injustice and racism, this foundation is not something that can ever be fully changed or addressed.",
    tagimg:
  ...
  {
    title: "Black Expectations",
    cardImage: "assets/images/project-page/blackExcellence.png",
    description: "Black people are continually treated as less and to be considered to be equal or normal only when they exceed everyone elses standerds.",
